...
+ si find_degenerations == 1:
    hallar los omega/c y im_epsi1 de cada degeneracion (mismo omega/c para dif modos)
"""
...
for Ep in list_Ep:
    ...
    info1 = 'Invisbilidad, R = %.2f $\mu$m, $\epsilon_\infty$ = %.2f, Ep = %.1f, $\gamma_{DL}$ = %.2f' %(R,epsiinf_DL,Ep,gamma_DL)
