...
for modo in list_modos:
    ...
    cond_inicial = fcond_inicial(R0,modo)
    ...
    if save_data_opt==1:
        ...
        np.savetxt('opt_det_sinkz_inv_vs_R_modo%i.txt' %(modo), tabla, fmt='%1.9e', delimiter='\t', header = header1)
