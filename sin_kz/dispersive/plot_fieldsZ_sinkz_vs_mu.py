...
path_save = path_basic + '/' + 'fields' + '/' + 'barrido_mu'
...
path_load = path_basic + '/' + 'real_freq' + '/' + 'epsiinf_DL_%.2f_vs_mu' %(epsiinf_DL)
os.chdir(path_load)
...
info1 = 'R = %.1f $\mu$m, $\mu_c$ = %.1f eV, $\epsilon_\infty$ = %.1f, Ep = %.1f eV, $\gamma_{DL}$ = %.2f eV' %(R,hbaramu,epsiinf_DL,Ep,gamma_DL)
