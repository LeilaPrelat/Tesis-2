...
try:
    ...
    print('Qscat_nano.py no se encuentra en el path_basic definido/carpeta de trabajo')
...
if save_graphs==1:
    os.chdir(path_save)
    # plt.tight_layout(1)
    plt.savefig('Qscat_fino_modo%i' %(modo)) 
...
if save_graphs==1:
    os.chdir(path_save)
    # plt.tight_layout(1)
    plt.savefig('Qscat_grueso_modo%i' %(modo)) 
...
if graph_2D==1:
    ...
    if save_graphs==1:
        os.chdir(path_save)
        plt.savefig('Qscat2D_modo%i' %(modo)) 
