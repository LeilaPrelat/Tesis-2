...
se resuelve numericamente el determinante sin kz ---> det_sinkz.py
...
try:
    ...
    print('det_sinkz.py no se encuentra en el path_basic definido/carpeta de trabajo')
    path_basic = input('path de la carpeta donde se encuentra det_sinkz.py')
    sys.path.insert(1, path_basic)
    from det_sinkz import determinante

#%%

def solve_det(omegac,re_epsi1,list_im_epsi1,modo,R,hbaramu,cond_inicial):   
    """
    Parameters
    ----------
