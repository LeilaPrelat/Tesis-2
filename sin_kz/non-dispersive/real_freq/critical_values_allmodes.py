...
fig,axs = plt.subplots(2,1, sharex=True, facecolor='w', figsize = tamfig2)
...
legend_mode2 = {'modo 1' : colors[0], 'modo 2' : colors[1],'modo 3' : colors[2], 'modo 4' : colors[3] }
patchList2 = []
...
plt.xlabel(labely,fontsize=tamletra,labelpad =labelpadx)
