...
try:
    ...
    print('Qabs_sinkz.py no se encuentra en el path_basic definido/carpeta de trabajo')
...
info1 = 'R = %.1f $\mu$m, nmax = %i, $\mu_c$ = %.1f eV, $\epsilon_1$ = %.1f - i%.2e' %(R,nmax,hbaramu,re_epsi1,-im_epsi1c)
