...
list_omegaTHz = np.linspace(1e-3,200,n)
list_kz = np.linspace(1e-3,4,n)
list_mu = np.linspace(0.3,0.9,n)

list_mu0 = [0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9]
list_kz0 = np.linspace(0.3, 2.5, 221) # para mu0 fijo 
   
path_save = path_basic + '/' +  r'/eta_%.2f_vs_mu/R_%.2f' %(eta,R)
