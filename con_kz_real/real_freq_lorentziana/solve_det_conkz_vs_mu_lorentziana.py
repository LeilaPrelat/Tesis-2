...
def fcond_inicial(kz_real,R,mu0):
    ...
    """
    home = '/home/leila/Desktop/Tesis-todo/Tesis-2/con_kz_real/real_freq'
    os.chdir( home + '/' + 're_epsi1_%.2f_vs_kz/R_%.2f/mu_%.1f' %(re_epsi1,R,mu0))
...
for mu in list_mu:
    ...
    def det_2variables(x):
        [omegac,eta] = x
        freq = omegac*c*1e12 # freq tiene que estar en THz para la funcion epsilon
