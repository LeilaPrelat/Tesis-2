...
def Et(kz,omegac,epsi1,nmax,R,mu_c,rho,phi,z,p1,p2,pz,rho_D,theta_D,z_D,Ao,Bo): 
    """
    Parameters
    ----------
...
def Ez(kz,omegac,epsi1,nmax,R,mu_c,rho,phi,z,p1,p2,pz,rho_D,theta_D,z_D,Ao,Bo): 
    """
    Parameters
    ----------
    kz : kz en 1/micrometros
...
def Etot(kz,omegac,epsi1,nmax,R,mu_c,rho,phi,z,p1,p2,pz,rho_D,theta_D,z_D,Ao,Bo): 
    """
    Parameters
    ----------
    kz : kz en 1/micrometros
...
def Ht(kz,omegac,epsi1,nmax,R,mu_c,rho,phi,z,p1,p2,pz,rho_D,theta_D,z_D,Ao,Bo): 
    """
    Parameters
    ----------
    kz : kz en 1/micrometros
...
def Hz(kz,omegac,epsi1,nmax,R,mu_c,rho,phi,z,p1,p2,pz,rho_D,theta_D,z_D,Ao,Bo): 
    """
    Parameters
    ----------
    kz : kz en 1/micrometros
...
def Htot(kz,omegac,epsi1,nmax,R,mu_c,rho,phi,z,p1,p2,pz,rho_D,theta_D,z_D,Ao,Bo): 
    """
    Parameters
    ----------
    kz : kz en 1/micrometros
